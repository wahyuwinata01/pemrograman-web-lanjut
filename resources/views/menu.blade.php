    ...
    <div class="w-100">
      ...
      <nav class="navbar navbar-expand navbar-primary navbar-dark">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route("table-saya")}}" class="nav-link">User</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route("table_kurir")}}" class="nav-link">Kurir</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route("table_paket")}}" class="nav-link">Paket</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route("table_kategori")}}" class="nav-link">Kategori</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route("table_tracking")}}" class="nav-link">Tracking</a>
          </li>
        </ul>
